...
// <div style={{ marginBottom: "20px" }} className="sortBtns">
...
//       {/* Search input */}
//       <div style={{ marginBottom: "20px" }} className="textBox">
//         <input
    ...
    <div style={{ padding: "20px" }} >
      ...
      <div className="controls">
        <div className="sort-section">
          <button onClick={() => sortProductsByName("asc")} className="sortbtns">Sort A-Z</button>
          <button onClick={() => sortProductsByName("desc")} className="sortbtns">Sort Z-A</button>
        </div>
        ...
        <div className="price-section">
          ...
          <label>
           <h6 className="price"> Min Price: ₹{minPrice}</h6>
            <input
              type="range"
              min="0"
              max="10000"
          ...
          <label>
          <h6 className="price">  Max Price: ₹{maxPrice} </h6>
            <input
              type="range"
              min="0"
              max="10000"
          ...
          <button className="filterBtn" onClick={filterByPrice}>Filter by Price</button>
        </div>
        ...
        <div className="search-section">
          ...
          <button onClick={searchProducts} className="sortbtns">Search</button>
          <button onClick={fetchProducts} className="sortbtns">Clear</button>
          </div>
        </div>
